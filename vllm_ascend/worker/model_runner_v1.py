    ...
    def _update_full_graph_params_if_needed(
        ...
        if (
            ...
            try:
                ...
                # Graph params updates run on update_stream.  Keep this barrier so
                # replay sees recorded update events, but do not synchronize the
                # current replay stream from graph_params_scope.
